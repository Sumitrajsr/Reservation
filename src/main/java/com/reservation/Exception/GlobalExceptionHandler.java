...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorDetails> driverExceptionHandler(RouteException se,WebRequest req)
	{
		ErrorDetails ed = new ErrorDetails();
		ed.setTimestamp(LocalDateTime.now());
		ed.setMessage(se.getMessage());
	...
	@ExceptionHandler(SubRouteException.class)
	public ResponseEntity<ErrorDetails> subRouteExceptionHandler(RouteException se,WebRequest req)
	{
		ErrorDetails ed = new ErrorDetails();
		ed.setTimestamp(LocalDateTime.now());
		ed.setMessage(se.getMessage());
	...
	public ResponseEntity<ErrorDetails> resourceNotFound(RouteException se,WebRequest req)
	{
		ErrorDetails ed = new ErrorDetails();
		ed.setTimestamp(LocalDateTime.now());
		ed.setMessage(se.getMessage());
	...
	public ResponseEntity<ErrorDetails> BlogAPIException(RouteException se,WebRequest req)
	{
		ErrorDetails ed = new ErrorDetails();
		ed.setTimestamp(LocalDateTime.now());
		ed.setMessage(se.getMessage());
